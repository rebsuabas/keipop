                        ...
                        <div class="inside">
                            <div class="main" style="padding:5px 15px 15px 15px;">
                            	<div style="float:left; vertical-align:top; width:calc(100% - 300px);;">
                                	<p style="font-size:30px; margin:0 0 10px; font-family:Constantia, 'Lucida Bright', 'DejaVu Serif', Georgia, serif"><?php _e('Welcome to wpForo', 'wpforo'); echo ' ' . esc_html(WPFORO_VERSION) ?></p>
                                ...
                                <div class="main">
                                    <table style="width:98%; margin:0 auto; text-align:left;">
                                        ...
                                        <?php if( wpforo_current_user_is('admin') ) : ?>
                                            <tr>
                                                <td colspan="2">
                                                    <p class="hndle" style="padding:25px 0 5px; margin:0; font-size:14px; font-weight:bold;">
                                                    ...
                                                    <div style="width:100%; padding:7px 0;">
                                                        <?php
                                                            ...
                                                            $reset_phrase_cache = wp_nonce_url( admin_url( 'admin.php?page=wpforo-community&wpfaction=wpforo_reset_phrase_cache' ), 'wpforo_reset_phrase_cache' );
                                                            $recrawl_phrases = wp_nonce_url( admin_url( 'admin.php?page=wpforo-community&wpfaction=wpforo_recrawl_phrases' ), 'wpforo_recrawl_phrases' );
                                                            $reset_user_cache = wp_nonce_url( admin_url( 'admin.php?page=wpforo-community&wpfaction=wpforo_reset_user_cache' ), 'wpforo_reset_user_cache' );
                                                            $synch_user_profiles = wp_nonce_url( admin_url( 'admin.php?page=wpforo-community&wpfaction=wpforo_synch_user_profiles' ), 'wpforo_synch_user_profiles' );
