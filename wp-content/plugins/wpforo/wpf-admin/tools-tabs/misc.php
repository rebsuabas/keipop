...
?>
	...
	<form action="" method="POST" class="validate">
        ...
        <input type="hidden" name="wpfaction" value="wpforo_misc_options_save">
                    ...
                    <tbody style="padding:10px;">
                        <tr>
                            <td>
                            	...
                            	<br>
                                <textarea name="wpforo_tools_misc[dofollow]" style="font-size: 13px; display:block; width:100%; height:120px;" placeholder="example.com"><?php wpfo(WPF()->tools_misc['dofollow']) ?></textarea>
                        	</td>
                        </tr>
                        <tr>
                            <td>
