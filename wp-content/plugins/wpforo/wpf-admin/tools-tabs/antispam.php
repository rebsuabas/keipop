...
?>
	...
	<?php if( !isset( $_GET['action'] ) ): ?>
    	...
    	<form method="POST" class="validate">
            ...
            <input type="hidden" name="wpfaction" value="wpforo_antispam_options_save">
                ...
                <div style="margin-top:10px; clear:both;">
                	<table style="width:100%;">
                      <tbody>
                        ...
                        <tr>
                            <th><label for="spam_filter_level_topic"><?php _e('Spam Suspicion Level for Topics', 'wpforo'); ?></label></th>
                            <td><input id="spam_filter_level_topic" type="number" min="0" max="100" name="wpforo_tools_antispam[spam_filter_level_topic]" value="<?php wpfo(WPF()->tools_antispam['spam_filter_level_topic']) ?>" class="wpf-field" /></td>
                        </tr> 	
                        <tr>
                            <th><label for="spam_filter_level_post"><?php _e('Spam Suspicion Level for Posts', 'wpforo'); ?></label></th>
                            <td><input id="spam_filter_level_post" type="number" min="0" max="100" name="wpforo_tools_antispam[spam_filter_level_post]" value="<?php wpfo(WPF()->tools_antispam['spam_filter_level_post']) ?>" class="wpf-field" /></td>
                        </tr> 
                        <?php if (class_exists('Akismet')): ?>
                        <tr>
                            <td colspan="2" style="color:#fff; background:#7C9B2E; font-size:20px; padding:10px 10px; text-align:center;"><strong>A&middot;kis&middot;met</strong> <?php _e(' is enabled','wpforo'); ?></td>
                        </tr> 
                        <?php endif; ?>	
                      </tbody>
                    </table>
                ...
                <div style="margin-top:10px; clear:both;">
                	<table style="width:100%;">
                      <tbody>
                        <tr>
                            <th style="width:65%;">
                            	<label for="new_user_max_posts"><?php _e('User is New (under hard spam control) during', 'wpforo'); ?></label>
                            </th>
                            <td><?php _e('first', 'wpforo'); ?> <input id="new_user_max_posts" type="number" min="0" name="wpforo_tools_antispam[new_user_max_posts]" value="<?php wpfo(WPF()->tools_antispam['new_user_max_posts']) ?>" class="wpf-field" style="width:50px;" /> <?php _e('posts', 'wpforo'); ?></td>
                        </tr>
                        <tr>
                            <th><label><?php _e('Posts must be manually approved','wpforo'); ?></label></th>
                            <td>
                                <div class="wpf-switch-field" style="padding: 2px 0 0 1px;">
                                    <input id="unapprove_post_if_user_is_new_yes" type="radio" name="wpforo_tools_antispam[unapprove_post_if_user_is_new]" value="1" <?php wpfo_check(WPF()->tools_antispam['unapprove_post_if_user_is_new'], 1); ?>/><label for="unapprove_post_if_user_is_new_yes" style="min-width: 50px;"><?php _e('Yes','wpforo'); ?></label> &nbsp;
                                    <input id="unapprove_post_if_user_is_new_no" type="radio" name="wpforo_tools_antispam[unapprove_post_if_user_is_new]" value="0" <?php wpfo_check(WPF()->tools_antispam['unapprove_post_if_user_is_new'], 0); ?>/><label for="unapprove_post_if_user_is_new_no" style="min-width: 50px;"><?php _e('No','wpforo'); ?></label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <th style="width:65%;"><label for="min_number_post_to_attach"><?php _e('Min number of posts to be able attach files', 'wpforo'); ?></label></th>
                            <td><input id="min_number_post_to_attach" type="number" min="0" name="wpforo_tools_antispam[min_number_post_to_attach]" value="<?php wpfo(WPF()->tools_antispam['min_number_post_to_attach']) ?>" class="wpf-field" style="max-width:80px;" /></td>
                        </tr>
                        <tr>
                            <th><label for="min_number_post_to_link"><?php _e('Min number of posts to be able post links', 'wpforo'); ?></label></th>
                            <td><input id="min_number_post_to_link" type="number" min="0" name="wpforo_tools_antispam[min_number_post_to_link]" value="<?php wpfo(WPF()->tools_antispam['min_number_post_to_link']) ?>" class="wpf-field" style="max-width:80px;" /></td>
                        </tr>
                        <tr>
                            <th colspan="2">
                                <label for="limited_file_ext"><?php _e( 'Do not allow to attach files with following extensions:', 'wpforo' ); ?></label>
                                <textarea id="limited_file_ext" name="wpforo_tools_antispam[limited_file_ext]" style="width:100%; height:60px; margin-top:10px;  color:#666666; background:#fdfdfd;"><?php echo esc_textarea( stripslashes( WPF()->tools_antispam['limited_file_ext'] ) ); ?></textarea>
                            </th>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div style="margin-top:10px; clear:both;">
                	<table style="width:100%;">
                      <tbody>
                        <tr>
                            <th style="width:35%;">
                            	<label for="rc_site_key"><?php _e('Site Key', 'wpforo'); ?>:</label>
                            </th>
                            <td><input id="rc_site_key" type="text" name="wpforo_tools_antispam[rc_site_key]" value="<?php wpfo(WPF()->tools_antispam['rc_site_key']) ?>" class="wpf-field" style="width: 100%" /></td>
                        </tr>
                        <tr>
                            <th style="width:35%;">
                            	<label for="rc_secret_key"><?php _e('Secret Key', 'wpforo'); ?>:</label>
                            </th>
                            <td><input id="rc_secret_key" type="text" name="wpforo_tools_antispam[rc_secret_key]" value="<?php wpfo(WPF()->tools_antispam['rc_secret_key']) ?>" class="wpf-field" style="width: 100%" /></td>
                        </tr>	  	
                      </tbody>
                    </table>
                </div>
            ...
            <div class="wpf-tool-box wpf-spam-attach left-box" style="max-height: inherit;">
                ...
                <div style="margin-top:0; clear:both;">
                    <table style="width:100%;">
                        <tbody>
                        <tr>
                            <td>
                                ...
                                <br>
                                <textarea name="wpforo_tools_antispam[html]" style="font-size: 13px; display:block; width:100%; height:120px;" placeholder="example.com"><?php wpfo(WPF()->tools_antispam['html']) ?></textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
			...
			<div class="wpf-tool-box wpf-spam-attach left-box" id="spam-files">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        <th style="width:50%; padding: 15px 0;"><label><?php _e('Enable File Scanner','wpforo'); ?>:</label></th>
                        ...
                        <tr>
                            <td colspan="2" style="width:50%;">
                                ...
                                <textarea name="wpforo_tools_antispam[exclude_file_ext]" style="font-size: 13px; display:block; width:100%; height:60px;" placeholder="example.com"><?php wpfo(WPF()->tools_antispam['exclude_file_ext']) ?></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
                      ...
                      <tbody>
								...
								while (false !== ($filename = readdir($handle))):
									...
									?>
										<tr>
										  ...
										  <td class="wpf-actions"><a href="<?php echo wp_nonce_url( admin_url( 'admin.php?page=wpforo-tools&tab=antispam&wpfaction=wpforo_delete_spam_file&sfname=' . urlencode($filename) ), 'wpforo_tools_antispam_files' ); ?>" title="<?php _e('Delete this file', 'wpforo'); ?>"  onclick="return confirm('<?php _e('Are you sure you want to permanently delete this file?', 'wpforo'); ?>');"><?php _e('Delete', 'wpforo'); ?></a></td>
										</tr>
									<?php 
								endwhile;
								closedir($handle);
                        ...
                        <tr style="background:#fff;">
                          <td colspan="2" class="wpf-actions" style="padding-top:20px; text-align:right;">
                          	<a href="<?php echo wp_nonce_url( admin_url( 'admin.php?page=wpforo-tools&tab=antispam&wpfaction=wpforo_delete_all_spam_files&level=1' ), 'wpforo_tools_antispam_files' ); ?>"
                            ...
                            <a href="<?php echo wp_nonce_url( admin_url( 'admin.php?page=wpforo-tools&tab=antispam&wpfaction=wpforo_delete_all_spam_files&level=2' ), 'wpforo_tools_antispam_files' ); ?>"
                            ...
                            <a href="<?php echo wp_nonce_url( admin_url( 'admin.php?page=wpforo-tools&tab=antispam&wpfaction=wpforo_delete_all_spam_files&level=3' ), 'wpforo_tools_antispam_files' ); ?>"
                            ...
                            <a href="<?php echo wp_nonce_url( admin_url( 'admin.php?page=wpforo-tools&tab=antispam&wpfaction=wpforo_delete_all_spam_files&level=4' ), 'wpforo_tools_antispam_files' ); ?>"
