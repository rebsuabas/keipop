            ...
            <div class="wpf-td wpfw-1 row_0-col_0" style="padding-top:10px;">
              <div class="wpf-field wpf-field-type-text">
                <div class="wpf-field-wrap">
                    ...
                    <input autofocus placeholder="<?php wpforo_phrase('Username') ?>" required type="text" name="log" class="wpf-login-text" />
                </div>
              ...
              <div class="wpf-field wpf-field-type-password">
                <div class="wpf-field-wrap"> 
                	<i class="fas fa-key wpf-field-icon"></i>
                  	<input placeholder="<?php wpforo_phrase('Password') ?>" required type="password" name="pwd" class="wpf-login-text" />
