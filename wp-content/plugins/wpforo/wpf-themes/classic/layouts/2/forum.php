	      	...
	      	<div class="wpforo-forum">
				...
				<?php if($forum['last_postid'] != 0) : ?>
			        ...
			        <div class="wpforo-last-post">
			            <p class="wpforo-last-post-title"><a href="<?php wpforo_unread_url($last_post['topicid'], $last_post['url']) ?>"><?php if(isset($last_post_topic['title'])) wpforo_text($last_post_topic['title'], 20); ?></a> <?php wpforo_unread_button($last_post['topicid'], $last_post['url']); ?></p>
