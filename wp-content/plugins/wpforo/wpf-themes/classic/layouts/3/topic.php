          ...
          <div class="wpforo-topic">
              ...
              <div class="wpforo-topic-info">
                <p class="wpforo-topic-title">
                    <a href="<?php wpforo_unread_url($topic['topicid'], $topic_url) ?>"><?php wpforo_topic_icon($topic); ?><?php wpforo_text($topic['title'], 70); ?></a> <?php wpforo_unread_button($topic['topicid'], $topic_url); ?> <?php wpforo_viewing( $topic ); ?></p>
