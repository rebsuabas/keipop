		...
		<div class="topic-wrap <?php wpforo_unread($topic['topicid'], 'topic'); ?>">
          <div class="wpforo-topic">
              ...
              <div class="wpforo-topic-info">
                <p class="wpforo-topic-title"><?php wpforo_topic_icon($topic, 'status'); ?> <a href="<?php wpforo_unread_url($topic['topicid'], $topic_url) ?>"><?php echo esc_html($topic['title']); ?></a> <?php wpforo_unread_button($topic['topicid'], $topic_url); ?> <?php wpforo_viewing( $topic ); ?></p>
