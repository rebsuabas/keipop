...
<div class="wpforo-profile-wrap">
	<?php if( !empty($user) && ( WPF()->current_userid == $user['userid'] || WPF()->perm->usergroup_can('vprf')) ) :
        ...
        $secondary_groups = ($secondary_groups) ? WPF()->usergroup->get_secondary_usergroup_names($secondary_groups) : array();
    ?>
                        ...
                        <div class="h-picture">
                            ...
                            <div class="wpf-profile-data-wrap">
                                <div class="profile-display-name">
                                    ...
                                    <?php endif; ?>
                                	<div class="profile-stat-data-item"><?php wpforo_phrase('Joined') ?>: <?php wpforo_date($user_registered, 'date') ?></div>
                                ...
                                <?php if( $rating_enabled ): ?>
                                    <div class="profile-rating-bar">
                                        <div class="profile-rating-bar-wrap" title="<?php wpforo_phrase('Member Rating') ?>">
                                            ...
                                            <?php $rating_level = ( wpfval( $stat, 'rating') ) ? $stat['rating'] : WPF()->member->rating_level( $posts, false ); ?>
